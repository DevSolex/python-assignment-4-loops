...
for grades in students:
    if grades['score'] >= 70:
        High_Performers.append({grades['id']:(grades['name'],grades['score'])})

    elif grades['score'] >= 50 and grades['score'] < 70:
        Average_Performers.append({grades['id']:(grades['name'],grades['score'])})
        
    elif grades['score'] < 50:
        Low_Performers.append({grades['id']:(grades['name'],grades['score'])})
        

print('High performance students:', len(High_Performers[:]))
print('Average performance students:', len(Average_Performers[:]))
print('Low performance students:', len(Low_Performers[:]))

print('All High performance students:', High_Performers)
print('All Average performance students:', Average_Performers)
print('All Low performance students:', Low_Performers)
